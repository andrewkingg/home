...
const Hero = () => {
  return (
      <div id="home" className='py-20 md:py-0 flex px-10 flex-col justify-center bg-gradient-to-br from-blue-950 via-gray-950 to-rose-950 min-h-[90vh]'>
            <div className="container max-w-[1200px] mx-auto flex flex-col md:flex-row text-white ">
                <div className="md:pl-10 order-2 md:order-1 flex-1 flex flex-col justify-center space-y-4 items-center md:items-start">
                    <h1 className="text-center md:text-left text-4xl sm:text-5xl font-semibold"><span className="gradient-text">Hi I'm Andrew King</span></h1>
                    <div className="flex space-x-2 text-sm lg:text-base">
                        ...
                        <div className="p-1 bg-rose-500 text-white rounded px-3">UX Designer</div>
                ...
                <div className="flex-1 flex items-center justify-center order-1">
                    <img className="mb-10 md:mb-0 w-[50%] sm:w-[40%] md:w-[60%] aspect-square object-cover p-2 sm:p-3 md:p-4 bg-white shadow-lg rounded-full" src="src\assets\heroPhotoz.jpg"/>
                </div>
            </div>
        </div>
  )
