...
class AboutDesc extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            desc: "Welcome! My name is Andrew King and I am a Web Designer and Developer. I graduated from the University of Virginia in May 2019 with a Bachelors of Arts in Computer Science. I started programming as a creative outlet when I was teenager, making various mini-games on Roblox.com. When my games got more popular I was able to see what a positive impact web applications could have on the lives of its users, and how much design impacted that experience. Thanks to those projects, I saw what potential programming and creativity could bring to its audience, and I knew I wanted to continue being a part of that. As a result I decided to pursuit a career in web design and web development and have since worked in both UX and Frontent Dev roles.",
            extra: "In my free time I really enjoy art, especially drawing. I also like to design website layouts, clothes, and edit videos. In college I was on a KPOP dance team and lived in the language exchange dorms, both of which were super enjoyable. Due to the extra time from quarantine, I've been heavily invested in reading web comics and web novels. I highly recommend the title 'Remarried Empress'!"
        }
    }
